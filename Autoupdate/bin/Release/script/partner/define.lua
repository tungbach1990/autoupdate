...
Partner.PARTNERLIMIT_MIN		 = 3;		-- 一个玩家默认状态下最多只能有3个同伴
...
Partner.PEEL_USABLE_MINTIME		  = 3600 * 3;	-- 高星级的同伴申请洗等级在3小时后才起效
Partner.PEEL_USABLE_MAXTIME 	  = 3600 * 6;	-- 高星级的同伴申请洗等级在6小时后失效
Partner.DEL_USABLE_MINTIME		  = Partner.PEEL_USABLE_MINTIME;
Partner.DEL_USABLE_MAXTIME		  = Partner.PEEL_USABLE_MAXTIME;
Partner.BIND_PARTNERQUIP_MINTIME  = 3600 * 6;	-- 6小时后可解绑同伴装备
Partner.BIND_PARTNERQUIP_MAXTIME  = 3600 * 9;	-- 9小时后申请解绑失效
