...
local tbGouhuoItem	= Item:GetClass("firewood_everyone");
...
function tbGouhuoItem:PickUp(nX, nY)
	...
	me.Msg("Bạn đã đốt lửa trại, chia sẻ kinh nghiệm xung quanh lửa trại!");
	return	0;
end
...
function tbGouhuoItem:CallGouhuoNpc(nX, nY, nExistentTime, nBaseMultip)
	...
	tbNpc:InitGouHuo(pNpc.dwId, 0,	nExistentTime, 5, 45, nBaseMultip, 0)
