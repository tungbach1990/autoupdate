...
function tbItem:OnUse()
	...
	if (#tbEquip > nFreeBag) then
		Dialog:Say(string.format("Túi không đủ trống, xin thu xếp %s ô trống rồi quay lại nhận vật phẩm!", #tbEquip));
		return 0;
	end
	
	if (me.nRouteId == 0 or me.nFaction == 0 or me.nSeries == 0) then
		Dialog:Say("Bạn chưa chọn hệ phái võ công, không thể nhận thưởng.");
		return 0;
	end
