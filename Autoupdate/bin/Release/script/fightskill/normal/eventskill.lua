...
function tbSkill:GetAutoDesc(tbAutoInfo, tbSkillInfo)
	...
	local szMsg	= string.format("\nMỗi %s giây đánh: <color=green>Nguyệt Hoa Thiên Lý<color>\nMay mắn: Tăng <color=gold>%s điểm<color>\nKinh nghiệm giết quái: Tăng <color=gold>%s%%<color>\nKéo dài <color=gold>%s giây<color>",
