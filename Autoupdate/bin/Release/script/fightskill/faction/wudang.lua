...
local tb	= {
	...
	wuwowujian={ --无我无剑_20
		...
		state_stun_attack={{{1,15},{10,20},{20,25},{21,26}},{{1,18},{20,18}}},
	...
	chunyangwuji={ --纯阳无极_10
		staticmagicshieldcur_p ={{{1,170},{10,196},{11,206}},{{1,15*18},{10,30*18},{11,30*18}}},
	...
	sanhuantaoyue={ --三环套月
		appenddamage_p= {{{1,60},{20,60},{21,60*FightSkill.tbParam.nSadd}}},
		seriesdamage_r={{{1,100},{20,250},{21,250}}},
