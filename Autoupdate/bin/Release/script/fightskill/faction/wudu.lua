...
local tb	= {
	...
	baiduchuanxin={ --百毒穿心_20
		appenddamage_p= {{{1,80},{10,80},{20,80},{21,80*FightSkill.tbParam.nSadd}}},
	...
	daodu120_child1={ --刀毒120_对敌加攻击_10
		skilldamageptrim={{{1,3},{10,30},{12,33}}},
		skillselfdamagetrim={{{1,3},{10,30},{12,33}}},
	...
	daodu120_child3={ --刀毒120_对敌减攻击_10
		skilldamageptrim={{{1,-2},{10,-15},{14,-18}}},
		skillselfdamagetrim={{{1,-2},{10,-15},{14,-18}}},
	...
	beimoxueguang_child={ --悲魔血光&子_20
		deadlystrikeenhance_r={{{1,-20},{10,-30},{20,-40},{21,-45}}},
